...
const Camera camera{look_from, look_at, {0.0, 1.0, 0.0}, 20.0, aspect_ratio};
...
main()
{
    ...
    scene.add(std::make_shared<Sphere>(Point{ 0.0, -100.5, -1.0},  100.0, chess ));
    scene.add(std::make_shared<Sphere>(Point{ 0.0,  0.0,   -1.0},  0.5,   aqua));
